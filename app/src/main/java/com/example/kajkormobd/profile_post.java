...
public class profile_post {
    ...
    public profile_post(String name, String image, String post_time, String work_name, String work_experience, String work_description, String work_location, String work_amount, String negotiable_condition, String work_phone, String user_id) {
        this.user_name = name;
