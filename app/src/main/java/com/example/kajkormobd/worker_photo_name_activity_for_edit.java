...
public class worker_photo_name_activity_for_edit extends AppCompatActivity {
    ...
    private DatabaseReference usersRdb  = FirebaseDatabase.getInstance().getReference().child("Contact");
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_worker_photo_name__edit_activity);
    ...
    private void saveUser(final String userId, String name , String mobile , String address, String imageUrl ){
        ...
        db.collection("users").document(userId)
                ...
                .addOnSuccessListener(new OnSuccessListener<Void>() {
                    ...
                    public void onSuccess(Void aVoid) {
                        ...
                        Intent intent = new Intent(worker_photo_name_activity_for_edit.this,Home.class);
