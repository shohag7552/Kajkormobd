...
public class fav_post_adpter extends FirestoreRecyclerAdapter<favorite_Posts, fav_post_adpter.postHolder> {





    public fav_post_adpter(@NonNull FirestoreRecyclerOptions<favorite_Posts> options) {
    ...
    @Override
    protected void onBindViewHolder(@NonNull postHolder holder, int position, @NonNull favorite_Posts model) {
    ...
    public postHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        ...
        View view = LayoutInflater.from(parent.getContext()).inflate(R.layout.favorite_post_item_for_recycle4,parent,false);
